export function salesFigure() {
  ...
  const initCharts = async () => {
    ...
    createChart('#Revenu_Status', {
      chart: { height: 345, type: 'bar', toolbar: { show: false } },
      ...
      grid: { borderColor: '#e0e6ed', strokeDashArray: 3, xaxis: { lines: { show: false } }, yaxis: { lines: { show: true } } },
      legend: { show: false },
      tooltip: { marker: { show: true }, x: { show: false } },
      fill: { opacity: 1 }
    })

    createChart('#dash_spark_1', {
