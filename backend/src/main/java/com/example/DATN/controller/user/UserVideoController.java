...
import com.example.DATN.service.user.UserVideoService;
...
public class UserVideoController {
    ...
    public ReadingWordLookupResponse lookupWord(
            @org.springframework.web.bind.annotation.RequestBody ReadingWordLookupRequest request) {
    ...
    public com.example.DATN.entity.UserVocabularyCustom saveWord(
            @org.springframework.web.bind.annotation.RequestBody SaveReadingWordRequest request) {
