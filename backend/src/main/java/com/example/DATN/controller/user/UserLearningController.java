...
import com.example.DATN.dto.user.UserLearningVocabDto;
import com.example.DATN.dto.user.UserLearningStatsDto;
import com.example.DATN.dto.user.ReviewQueueItemDto;
import com.example.DATN.dto.user.BulkSubmitReviewResultRequest;
import com.example.DATN.dto.user.SubmitReviewResultRequest;
...
public class UserLearningController {
    ...
    public ResponseEntity<?> getReviewQueue(Authentication auth, HttpServletRequest request) {
        ...
        List<ReviewQueueItemDto> dtos = dueReviews.stream().<ReviewQueueItemDto>map(r -> {
    ...
    public ResponseEntity<?> getAllLearningVocab(Authentication auth, HttpServletRequest request) {
        ...
        if (!vocabIds.isEmpty()) {
            List<com.example.DATN.entity.LessonVocabulary> mappings = lessonVocabularyRepository
                    .findByVocabIdIn(vocabIds);
