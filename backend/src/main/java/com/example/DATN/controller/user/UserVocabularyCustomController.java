...
import com.example.DATN.dto.user.SaveCustomVocabularyRequest;
import com.example.DATN.dto.user.UserVocabularyCustomDto;
import com.example.DATN.entity.User;
import com.example.DATN.entity.UserVocabularyCustom;
import com.example.DATN.repository.user.UserRepository;
import com.example.DATN.service.user.UserHomepageService;
import com.example.DATN.service.user.UserVocabularyCustomService;
        ...
        try {
            ...
            if (request.addToSRS) {
                ...
                if (setsLimitMap != null && Boolean.TRUE.equals(setsLimitMap.get("IS_LOCKED"))) {
                    return ResponseEntity.status(HttpStatus.FORBIDDEN)
                            .body("Tính năng tạo bộ từ vựng tùy chỉnh hiện đang bị khóa cho gói cước của bạn.");
                }
