...
public class UserVocabularyCustomService {
    ...
    public UserVocabularyCustom update(Long id, UserVocabularyCustom vocabUpdates) {
        ...
        if (existing.isPresent()) {
            ...
            if (vocabUpdates.word != null) vocab.word = vocabUpdates.word;
            if (vocabUpdates.pronunciation != null) vocab.pronunciation = vocabUpdates.pronunciation;
            if (vocabUpdates.phonetic != null) vocab.phonetic = vocabUpdates.phonetic;
            if (vocabUpdates.partOfSpeech != null) vocab.partOfSpeech = vocabUpdates.partOfSpeech;
            if (vocabUpdates.meaningEn != null) vocab.meaningEn = vocabUpdates.meaningEn;
            if (vocabUpdates.meaningVi != null) vocab.meaningVi = vocabUpdates.meaningVi;
            if (vocabUpdates.example != null) vocab.example = vocabUpdates.example;
            if (vocabUpdates.exampleVi != null) vocab.exampleVi = vocabUpdates.exampleVi;
            if (vocabUpdates.level != null) vocab.level = vocabUpdates.level;
            if (vocabUpdates.levelSource != null) vocab.levelSource = vocabUpdates.levelSource;
            vocab.updatedAt = new Date();
