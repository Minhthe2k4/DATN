...
import com.example.DATN.repository.premium.PremiumFeatureLimitRepository;
...
public class PremiumService {
    ...
    private final PremiumFeatureLimitRepository featureLimitRepository;

    public PremiumService(UserSubscriptionRepository subscriptionRepository,
            UserRepository userRepository,
            PremiumPlanRepository planRepository,
            PremiumFeatureLimitRepository featureLimitRepository) {
    ...
    public void checkAndIncrementActionLimit(Long userId, String featureId, String featureLabel, String periodType) {
        ...
        if (featureId.equals("SAVED_VOCABULARY")) {
