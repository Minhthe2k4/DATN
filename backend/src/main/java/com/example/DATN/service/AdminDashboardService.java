...
public class AdminDashboardService {
        ...
        public AdminDashboardOverviewResponse getOverview() {
                ...
                long newUsersToday = userRepository.countByCreatedAtGreaterThanEqualAndCreatedAtLessThan(startOfDay,
                                endOfDay);
                ...
                long dailyStudySessions = reviewSessionRepository
                                .countByCreatedAtGreaterThanEqualAndCreatedAtLessThan(startOfDay, endOfDay);
                long dailyLogins = reviewSessionRepository.countDistinctUsersInRange(startOfDay, endOfDay);
                long dailyReviews = reviewHistoryRepository
                                .countByCreatedAtGreaterThanEqualAndCreatedAtLessThan(startOfDay, endOfDay);
                ...
                List<AdminDashboardOverviewResponse.StatCard> stats = List.of(
                                ...
                                new AdminDashboardOverviewResponse.StatCard(
                                                ...
                                                pausedTopics + " chủ đề tạm dừng, " + (draftLessons + draftReadings)
                                                                + " mục nháp/chờ biên tập",
                                                "iconoir-edit-pencil"),
                                new AdminDashboardOverviewResponse.StatCard(
                ...
                List<AdminDashboardOverviewResponse.PremiumRequestItem> premiumRequests = transactionRepository
                                ...
                                .map(row -> new AdminDashboardOverviewResponse.PremiumRequestItem(
                                                ...
                                                row.getRequestedAt() == null ? "-"
                                                                : row.getRequestedAt().format(DATE_TIME_FORMATTER),
