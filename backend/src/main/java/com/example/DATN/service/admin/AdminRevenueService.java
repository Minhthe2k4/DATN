...
import com.example.DATN.repository.projections.RevenueTransactionProjection;
...
public class AdminRevenueService {
    ...
    public AdminRevenueOverviewResponse getOverview() {
        ...
        long activePremiumUsers = userSubscriptionRepository
                .countDistinctActivePremiumUsers(java.time.LocalDateTime.now());
